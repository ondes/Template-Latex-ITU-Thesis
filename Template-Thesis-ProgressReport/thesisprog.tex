% ----------------------------------------------------------------- %
%            ITU LaTeX Thesis Progress Report Template	            %
%                                                                   %
%		         		Version 1.0                       	        %
% ----------------------------------------------------------------- %
...
% https://github.com/ondes/Template-Latex-ITU-Thesis-Progress-Report%
% ----------------------------------------------------------------- %
...
\documentclass[onluarkali,ingilizce,yukseklisans,fenbilimleri]{thesisprog_itu}
...
% ----------------------------------------------------------------- %
% The progress report submission date in upper case letters         %
% Place the report number without including th/st/nd                %
% ----------------------------------------------------------------- %

\reportno{1}
\tarih{AY / AY YIL}{MONTH / MONTH YEAR}
...
\title{THESIS TITLE HERE} % If just first letters are capital: Thesis Title Here
